...
<body>
    ...
    <div class="no-print" style="text-align: center; margin-top: 20px;">
        ...
        <button onclick="window.location.href='billing.php'" style="padding: 10px 20px; font-size: 14px; cursor: pointer; margin-left: 10px; background: #667eea; color: white; border: none; border-radius: 5px;">Back to Billing</button>
        <button onclick="window.location.href='invoices.php'" style="padding: 10px 20px; font-size: 14px; cursor: pointer; margin-left: 10px; background: #6c757d; color: white; border: none; border-radius: 5px;">View All Invoices</button>
    </div>
...
<body>
    <div class="invoice-container">
        ...
        <div class="no-print" style="text-align: center; margin-top: 30px;">
            ...
            <button onclick="window.location.href='billing.php'" style="padding: 12px 30px; font-size: 16px; background: #4caf50; color: white; border: none; border-radius: 5px; cursor: pointer; margin-right: 10px;">Create New Bill</button>
